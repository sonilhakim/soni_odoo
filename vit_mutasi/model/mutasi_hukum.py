...
class mutasi_hukum(models.Model):
    ...
    mutasi_hukum_detail_ids = fields.One2many(comodel_name="vit.mutasi_hukum_detail",  inverse_name="mutasi_hukum_id",  string="Mutasi hukum detail",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
