...
class mutasi_pengajuan_angka_kredit(models.Model):
    ...
    _description = "vit.mutasi_pengajuan_angka_kredit"
    ...
    mutasi_ak_detail_ids = fields.One2many(comodel_name="vit.mutasi_ak_detail",  inverse_name="mutasi_ak_id",  string="Mutasi ak detail",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
