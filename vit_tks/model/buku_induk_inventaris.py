...
class buku_induk_inventaris(models.Model):
    ...
    _description = "vit.buku_induk_inventaris"
    ...
    induk_detail_ids = fields.One2many(comodel_name="vit.buku_induk_inventaris_detail",  inverse_name="buku_induk_id",  string="Induk detail",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
