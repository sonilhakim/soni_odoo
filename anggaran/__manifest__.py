{
    ...
    'depends': ['base','account','product', 'hr', 'vit_account_period', 'vit_univ_common'],
    ...
    'data': [
      ...
      # 'data/data_master.xml',
      # 'data/data_uom_coa.xml',
      # 'data/data_kebijakan.xml',
      # 'data/data_program.xml',
      # 'data/data_kegiatan.xml',
      # 'data/data_rka.xml',
      ...
      'report/paper.xml',
      'report/renbut.xml',
      'report/renbut_detail.xml',
      'report/rarenja.xml',
      'report/rarenja_detail.xml',
      'report/renja.xml',
      'report/renja_detail.xml',
      'report/rka.xml',
