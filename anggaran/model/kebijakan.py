...
class kebijakan(models.Model):
    ...
    category_id 	= fields.Many2one(comodel_name='anggaran.category', string='Kategori')
    program_ids		= fields.One2many(comodel_name='anggaran.program',inverse_name='kebijakan_id',string='Programs', ondelete="cascade")
