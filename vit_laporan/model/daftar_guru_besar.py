...
class daftar_guru_besar(models.Model):
    ...
    _description = "vit.daftar_guru_besar"
    ...
    gb_detail_ids = fields.One2many(comodel_name="vit.gb_detail",  inverse_name="gb_id",  string="Gb detail",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
