...
class dp3(models.Model):
    ...
    detail_nilai_ids = fields.One2many(comodel_name="vit.detail_penilaian",  inverse_name="dp3_id",  string="Detail nilai",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
