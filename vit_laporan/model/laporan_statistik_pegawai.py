...
class laporan_statistik_pegawai(models.Model):
    ...
    _description = "vit.laporan_statistik_pegawai"
    ...
    stat_detail = fields.One2many(comodel_name="vit.lap_statistik_detail",  inverse_name="statistik_id",  string="Stat detail",  readonly=True, states={"draft" : [("readonly",False)]},  help="")
