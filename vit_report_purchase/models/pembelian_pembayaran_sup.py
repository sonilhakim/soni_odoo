...
class BeliBayarSup(models.Model):
    _name          = 'vit.pembelian_pembayaran_sup'
    _description   = 'vit.pembelian_pembayaran_sup'
...
class BeliBayarSupLine(models.Model):
    _name = 'vit.pembelian_pembayaran_sup_line'
    _description = "vit.pembelian_pembayaran_sup_line"