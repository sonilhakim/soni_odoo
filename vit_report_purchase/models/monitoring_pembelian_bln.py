...
class MonitoringPembelian(models.Model):
    _name          = 'vit.monitoring_pembelian_bln'
    _description   = 'vit.monitoring_pembelian_bln'
...
class MonitoringPembelianLine(models.Model):
    _name = 'vit.monitoring_pembelian_bln_line'
    _description = 'vit.monitoring_pembelian_bln_line'