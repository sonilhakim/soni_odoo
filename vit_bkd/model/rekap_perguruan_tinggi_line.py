...
class rekap_perguruan_tinggi_line(models.Model):
    ...
    _description = "vit.rekap_perguruan_tinggi_line"
    ...
    rekap_perguruan_tinggi_id = fields.Many2one(comodel_name="vit.rekap_perguruan_tinggi",  string="Rekap perguruan tinggi",  help="")
