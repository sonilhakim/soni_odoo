...
class kinerja_bidang_pendidikan(models.Model):

    _name = "vit.kinerja_bidang_pendidikan"
    _description = "vit.kinerja_bidang_pendidikan"
    ...
    jenis_kegiatan_id = fields.Many2one(comodel_name="vit.jenis_kegiatan_pendidikan",  string="Jenis kegiatan",  help="")
