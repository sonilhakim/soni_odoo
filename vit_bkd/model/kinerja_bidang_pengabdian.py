...
class kinerja_bidang_pengabdian(models.Model):

    _name = "vit.kinerja_bidang_pengabdian"
    _description = "vit.kinerja_bidang_pengabdian"
    ...
    rekomendasi_id = fields.Many2one(comodel_name="vit.rekomendasi",  string="Rekomendasi",  help="")
    jenis_kegiatan_id = fields.Many2one(comodel_name="vit.jenis_kegiatan_pengabdian",  string="Jenis kegiatan",  help="")
